...
class DiseaseCard2 extends StatefulWidget {
  const DiseaseCard2({super.key});

  @override
  State<DiseaseCard2> createState() => _DiseaseCard2State();
}

class _DiseaseCard2State extends State<DiseaseCard2> {
  bool _show = false;
  @override
      ...
      Container(
          ...
          child: Stack(
            children: [
              Column(
                children: [
                  Image.asset("lib/assets/tomatoun.jpeg",
